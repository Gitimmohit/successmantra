  ...
  const achievements = [
    {
      ...
      description:
        "Grateful to Success Mantra for their expert guidance and continuous support throughout my preparation journey. This achievement wouldn't have been possible without their structured approach and dedicated mentorship.",
      date: "2024",
      image: first,
      category: "Sbi Po",
    },
    {
      ...
      description:
        "Heartfelt thanks to Success Mantra for their unwavering support and expert guidance which played a crucial role in my SBI Clerk success.",
      date: "2024",
...

    {
      ...
      description:
        "Grateful to Success Mantra for their consistent guidance, mock tests, and personal mentorship that helped me crack SSC GD.",
      date: "2024",
...

    {
      ...
      description:
        "Heartfelt thanks to Success Mantra for their expert mentorship and structured preparation strategy that helped me secure selection in SBI PO.",
      date: "2024",
    ...
    },
    {
      ...
      description:
        "Thanks to Success Mantra's innovative teaching and continuous guidance, I successfully cleared the SBI PO Prelims 2024 on my first attempt.",
      date: "2024",
    ...
    },
    {
      ...
      description:
        "Thanks to Success Mantra’s strategic guidance and consistent support, I successfully cleared the Bihar Police Exam 2023. Grateful for the journey!",
      date: "5 Nov 2023",
  ...
  const [feedback, setFeedback] = useState([
    {
      ...
      rating: 5,
      comment:
        "Securing 9th rank in SBI PO was a dream come true. Success Mantra’s structured guidance, practice sessions, and personal mentorship helped me stay focused and consistent throughout the journey.",
      image: first,
      selected: true,
    },
    {
      ...
      rating: 5,
      comment:
        "I owe my success in SBI Clerk 2024 to Success Mantra. Their test series and concept clarity sessions made all the difference. Thank you for being the guiding light in my journey.",
      image: second,
      selected: false,
    },
    {
      ...
      rating: 5,
      comment:
        "Clearing SSC GD felt easy with the kind of consistent support and mock drills provided by Success Mantra. Truly grateful for the team’s dedicated efforts!",
      image: third,
      selected: false,
    },
    {
      ...
      rating: 5,
      comment:
        "Cracking SBI PO wouldn't have been possible without Success Mantra’s personalized strategy and focused approach. The faculty here is top-notch.",
      image: four,
      selected: false,
    },
    {
      ...
      rating: 5,
      comment:
        "Thank you Success Mantra for guiding me to crack the SBI PO Prelims on my first attempt. The innovative teaching style made complex topics so much easier!",
      image: five,
      selected: false,
    },
    {
      ...
      rating: 5,
      comment:
        "Clearing Bihar Police exam was only possible because of Success Mantra’s well-structured classes and practice-based approach. Forever thankful!",
      image: six,
      selected: false,
    },
  ]);
      ...
      <div className="gr-gallery-page">
        ...
        <div className="gr-achievements-grid">
          {achievements.map((achievement, index) => (
            <div
              key={achievement.id}
              className={`gr-achievement-card gr-animate-on-scroll gr-delay-${
                index % 3
              }`}
            >
        ...
        <div className="gr-news-section">
          {news.map((item, index) => (
            <div
              key={item.id}
              className={`gr-news-card gr-animate-on-scroll gr-delay-${
                index % 2
              }`}
            >
              <h3>{item.title}</h3>
        ...
        <div className="gr-feedback-section">
          <div className="gr-section-title gr-animate-on-scroll">
            ...
            <p className="gr-section-subtitle">
              Hear what our successful candidates say about us
            </p>
          </div>
            ...
            <div className="gr-feedback-carousel">
              ...
              <div className="gr-feedback-cards">
                {feedback.map((item, index) => (
                  <div
                    key={item.id}
                    className={`gr-feedback-card ${
                      index === activeFeedback ? "gr-active" : ""
                    }`}
                    style={{
                      transform: `translateX(${
                        (index - activeFeedback) * 120
                      }%)`,
                  ...
                  >
                    ...
                    <div className="gr-feedback-content">
                      ...
                      <p className="gr-feedback-comment">{item.comment}</p>
                      <div className="gr-feedback-rating">
                        {[...Array(5)].map((_, i) => (
                          <FaStar
                            key={i}
                            className={
                              i < item.rating ? "gr-star gr-filled" : "gr-star"
                            }
                          />
                        ))}
                      </div>
                  ...
                  {[1, 2, 3, 4, 5].map((star) => (
                    <React.Fragment key={star}>
                      ...
                      <label htmlFor={`star-${star}`} className="gr-star-label">
                        <FaStar
                          className={star <= formData.rating ? "gr-filled" : ""}
                        />
                      </label>
                    </React.Fragment>
                  ))}
